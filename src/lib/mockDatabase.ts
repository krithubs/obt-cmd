  ...
  private news: NewsItem[] = [
    {
      ...
      content: 'เรียนประชาชนในเขตตำบลโหล่งขอด ร่วมกันจัดเก็บขยะอย่างถูกวิธีตามวันและเวลาที่กำหนด โดยจะมีเจ้าหน้าที่เข้าไปรับขยะตามเส้นทางที่กำหนด ทุกวันอังคารและวันศุกร์ เวลา 08:00-12:00 น. ขอให้ประชาชนแยกขยะและวางไว้หน้าบ้านในถุงที่เหมาะสม',
    ...
    },
    {
      ...
      content: 'ทางองค์การบำเพศีจะจัดกิจกรรมวันสิงหาในวันที่ 15 เมษายนนี้ ณ สนามกีฬาอบต.โหล่งขอด โดยจะมีพิธีทำบุญตักบาตรในเวลา 09:00 น. ตามด้วยกิจกรรมมอบของที่ระลึกแก่ผู้สูงอายุในพื้นที่',
      category: 'ACTIVITY',
      isActive: true,
    ...
    },
    {
      ...
      content: 'จะมีการปิดปรับปรุงถนนสายหลักในวันที่ 20-25 มี.ค. 2567 บนถนนโหล่งขอด-หมู่ 2 โดยจะปิดเวลา 09:00-16:00 น. ขอให้ผู้ใช้รถใช้เส้นทางอ้อมเพื่อความปลอดภัยและสะดวกในการเดินทาง',
      category: 'WARNING',
      isActive: true,
    ...
    },
    {
      ...
      content: 'อบต.โหล่งขอดได้รับงบประมาณสนับสนุนการสร้างสะพานคอนกรีตข้ามคลองโหล่งขอด มูลค่า 5 ล้านบาท คาดว่าจะเริ่มก่อสร้างในเดือนพฤษภาคมนี้ และแล้วเสร็จภายใน 3 เดือน',
      category: 'NEWS',
      isActive: true,
    ...
    },
    {
      ...
      content: 'จัดอบรมการเกษตรอินทรีย์ให้กับเกษตรกรในพื้นที่ วันที่ 25 มี.ค. 2567 เวลา 09:00-12:00 น. ณ ศาลากลางอบต.โหล่งขอด โดยผู้เชี่ยวชาญจากกรมวิชาการเกษตร',
      category: 'ACTIVITY',
      isActive: true,
    ...
    },
    {
      ...
      content: 'อบต.โหล่งขอดเปิดรับสมัครนักเรียนที่มีคุณสมบัติเพื่อรับทุนการศึกษาประจำปี 2567 โดยมีเงินสนับสนุน 5,000 บาทต่อคน สามารถยื่นใบสมัครได้ถึงวันที่ 30 เมษายน 2567',
      category: 'ANNOUNCEMENT',
      isActive: true,
    ...
    },
    {
      ...
      content: 'ติดตั้งป้ายไฟสัญญาณใหม่บริเวณสี่แยกหลักอบต.โหล่งขอด เพื่อความปลอดภัยในการจราจร และลดอุบัติเหตุในพื้นที่ โดยจะเริ่มใช้งานวันที่ 1 เมษายน 2567',
      category: 'NEWS',
      isActive: true,
    ...
    },
    {
      ...
      content: 'จัดประกวดแข่งขันกีฬาฟุตบอล "ถ้วยผู้ใหญ่อบต.โหล่งขอด" ในวันที่ 10 เมษายน 2567 ณ สนามกีฬาอบต.โหล่งขอด ทีมที่สนใจสามารถสมัครได้ถึงวันที่ 5 เมษายน 2567',
      category: 'ACTIVITY',
      isActive: true,
