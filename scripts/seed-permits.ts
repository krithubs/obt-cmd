...
const seeds: Seed[] = [
  // ───── กองช่าง ─────
  {
    ...
    description: 'กองช่าง — คำร้องขอติดตั้ง/ใช้บริการน้ำประปาในเขตผู้ใหญ่ลี',
  ...
  },
  {
    ...
    category: 'construction',
    description:
      'กองช่าง — หนังสือรับรองสิ่งปลูกสร้างหรืออาคารต่อเติมจากผู้ใหญ่ลี ใช้ประกอบการขอเลขที่บ้าน ขอใช้ไฟฟ้า/น้ำประปา หรืออื่น ๆ ตามที่ราชการกำหนด',
    requiredDocs: [
      ...COMMON_DOCS,
  ...
  },
  {
    ...
    category: 'construction',
    description: 'กองช่าง — แจ้งให้ผู้ใหญ่ลีดำเนินการซ่อมไฟฟ้าสาธารณะ (ไฟกิ่ง/ไฟถนน) ที่ชำรุด',
    requiredDocs: [
      ...ID_DOCS,
  ...
  },
  {
    ...
    category: 'construction',
    description: 'กองช่าง — แจ้งให้ผู้ใหญ่ลีดำเนินการซ่อมระบบประปาหมู่บ้านที่ชำรุด',
    requiredDocs: [
      ...ID_DOCS,
      { key: 'broken_photo', label: 'รูปถ่ายจุดที่ชำรุด', required: true },
      { key: 'location_map', label: 'แผนที่/พิกัดจุดที่ชำรุด', required: true },
  ...
  },
  {
    ...
    category: 'business',
    description:
      'กองคลัง — แบบแจ้งการฆ่าสัตว์เพื่อจำหน่ายเนื้อในเขตผู้ใหญ่ลี ตาม พ.ร.บ. ควบคุมการฆ่าสัตว์เพื่อการจำหน่ายเนื้อสัตว์',
    requiredDocs: [
      ...ID_DOCS,
  ...
  // ───── กองคลัง — จดทะเบียนพาณิชย์ ─────
  {
    ...
    category: 'commercial',
    description: 'กองคลัง — สำหรับร้านค้าทั่วไป ทั้งบุคคลธรรมดาและนิติบุคคลในเขตผู้ใหญ่ลี',
    requiredDocs: [
      ...COMMON_DOCS,
  ...
  },
  {
    ...
    category: 'tax',
    description:
      'กองคลัง — แบบแสดงรายการภาษีป้ายประจำปี สำหรับผู้ติดตั้งป้ายโฆษณาในเขตผู้ใหญ่ลี ยื่นภายใน 31 มีนาคม ของทุกปี',
    requiredDocs: [
      ...ID_DOCS,
  ...
  // ───── กองคลัง — พัสดุ ─────
  {
    ...
    category: 'general',
    description: 'กองคลัง — สำหรับขอยืมพัสดุหรือครุภัณฑ์ของผู้ใหญ่ลี เช่น เต็นท์ โต๊ะ เก้าอี้ เครื่องเสียง',
    requiredDocs: [
  ...
  // ───── ทั่วไป ─────
  {
    ...
    category: 'general',
    description: 'คำขอเข้าถึงข้อมูลข่าวสารของผู้ใหญ่ลี ตาม พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540',
    requiredDocs: [
  ...
  },
  {
    ...
    category: 'general',
    description: 'แบบฟอร์มหนังสือมอบอำนาจทั่วไปสำหรับใช้ประกอบคำขอ/ติดต่อกับผู้ใหญ่ลี แทนผู้มอบอำนาจ',
    requiredDocs: [
